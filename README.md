...
- [ajhaller/igsights](https://github.com/ajhaller/igsights): An interactive dashboard tracking my loc journey over time, featuring growth progress, maintenance notes, and visual comparisons to document and celebrate each stage - UNDER CONSTRUCTION
...
- [RiceD2KLab/Pop_F24](https://github.com/RiceD2KLab/Pop_F24): Leverages Natural Language Programming (NLP) machine learning models, to provide voters with insight into about politicians' actions and stances on significant issues
-----------
